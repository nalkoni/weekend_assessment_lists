...
SELECT Models.name, brand_name, Brands.headquarters AS headquarters
FROM Models
LEFT JOIN Brands
...
SELECT brands.name, founded, models.name as model_name
FROM brands
LEFT JOIN models
...
SELECT b.name AS brand_name, m.name AS model_name, m.year, b.discontinued, b.discontinued - m.year AS years_until_brand_discontinued
FROM models AS m
